...
left={ mean_vec_CO_2,mean_vec_CO_2,mean_vec_CO_2,mean_vec_CO_2,mean_vec_CO_2,mean_vec_CO_2};
...
%% NO
figure('Units', 'normalized', 'Position', [0 0 1 1])
sgtitle('Linear curve (y = sx+o) fit on NO data','fontweight','bold','fontsize',32)

left={ mean_vec_NO_2,mean_vec_NO_2,mean_vec_NO_2,mean_vec_NO_2,mean_vec_NO_2,mean_vec_NO_2};
...
%% NO_2
figure('Units', 'normalized', 'Position', [0 0 1 1])
sgtitle('Linear curve (y = sx+o) fit on NO_2 data','fontweight','bold','fontsize',32)

left={ mean_vec_NO2_2,mean_vec_NO2_2,mean_vec_NO2_2,mean_vec_NO2_2,mean_vec_NO2_2,mean_vec_NO2_2};
...
%% OX
figure('Units', 'normalized', 'Position', [0 0 1 1])
sgtitle('Linear curve (y = sx+o) fit on OX data','fontweight','bold','fontsize',32)

left={ mean_vec_OX_2,mean_vec_OX_2,mean_vec_OX_2,mean_vec_OX_2,mean_vec_OX_2,mean_vec_OX_2};
